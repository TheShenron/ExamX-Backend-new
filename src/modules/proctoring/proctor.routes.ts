...
import { addProctoringResult, deleteProctoringResult, getUserProctoringResult } from "./proctor.controller";
...
router.get("/:resultId/:userId/proctoring", verifyToken, validateReq({ params: getProctoringResultSchema }), allowRoles(ADMIN, HR), getUserProctoringResult);
